    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            case "Editar": 
                ...
                request.getRequestDispatcher("vista/Propietario/editServicio.jsp").forward(request, response);
                break;
            case "Actualizar":   
            ...
            default:
                out.println("<script type=\"text/javascript\">");
                out.println("window.location.href='/booktripO/vista/Dashboard/indexListaServicio.jsp';");
                out.println("</script>");
