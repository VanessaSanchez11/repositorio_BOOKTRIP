...
public class pruebaEliminarUsuario {
    ...
    public static void main(String[] args) {
        ...
        usuario user = userC.consultarUsuario(3);

        if (user != null) {
            System.out.println("Encontrado el usuario  " + user.getIdUsuario() + "  -  " + user.getNombre());
        ...
        userC.EliminarUsuario(listaUsuarios.get(2));
