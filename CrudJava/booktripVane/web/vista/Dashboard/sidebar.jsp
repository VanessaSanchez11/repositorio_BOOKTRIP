     ...
     <li class="nav-item">
         ...
         <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="indexRolRegister.jsp">Roles</a>
                 <a class="collapse-item" href="indexListaUsuario.jsp">Lista de usuarios</a>
                 <a class="collapse-item" href="indexTipoDocuRegister.jsp">Tipo de documento</a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="index1.php">Tipos de inmuebles</a>
                 <a class="collapse-item" href="index1.php">Estados</a>
