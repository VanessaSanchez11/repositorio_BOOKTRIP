...
(application.getRealPath("reportes/inmuebles.jasper"));
Map<String, Object> parameter = new HashMap<String, Object>();

int cod1=Integer.parseInt(request.getParameter("codigo_1"));
int cod2=Integer.parseInt(request.getParameter("codigo_2"));

parameter.put("cod_1", new Integer(cod1));
parameter.put("cod_2", new Integer(cod2));
