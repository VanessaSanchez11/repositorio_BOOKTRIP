        ...
        <div class="container  col-md-6 mt-5 bg-light form-group">
           ...
           <form action="/booktripO/controllerServicio" method="POST" onsubmit="return validar()">
                <div col-md-6>
                    ...
                    <div col-md-3><input type="text" name="txtNombre" id="txtNombre">
                    </div>
                </div>
                
                <div col-md-6>
                    <div col-md-3><label>Descripcion:</label></div>
                    <div col-md-3><input type="text" name="txtDescripcion" id="txtDescripcion">
                    </div>
                </div>
