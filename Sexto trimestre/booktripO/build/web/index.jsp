...
<html lang="en">
    ...
    <script src="../web/vista/bootstrap/js/bootstrap.min.js"></script>
    <script src="../web/vista/bootstrap/js/bootstrap.bundle.min.js"></script>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Iniciar sesiónprueba index</h1>
                                    </div>
