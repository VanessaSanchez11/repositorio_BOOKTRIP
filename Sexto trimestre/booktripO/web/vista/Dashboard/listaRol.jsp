                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left:25px;">
                                            <form action="/booktripO/controllerRoles" method="POST">
                                                ...
                                                <a href="#" name="accion" value="Actualizar" class="d-none d-sm-inline-block btn btn-warning shadow-sm" onclick="actualizar()"> Actualizar</a>
                                                <input type="submit" name="accion" value="Delete" class="btn btn-danger " onclick="return confirm('Está seguro que deseas eliminar el registro?');">
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
