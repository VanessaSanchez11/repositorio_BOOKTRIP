    ...
    <center>
        ...
        <div>
            <form action="/booktripO/controllerPago" method="POST">
                <input type="submit" name="accion" value="Listar" class="btn-success" >
                <input type="submit" name="accion" value="Nuevo" class="btn-danger">
            </form>
        </div>
        <hr>
        <div>
                        ...
                        <tr>
                            ...
                            <td style="padding-left:25px;">
                                <form action="/booktripO/controllerPago" method="POST">
                                    ...
                                    <input type="submit" name="accion" value="Editar" class="btn-success">
