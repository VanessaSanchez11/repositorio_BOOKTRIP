            ...
            <table border="1" class=" bg-light table table-light"  style="width: 500px;">
                ...
                <tbody style="height: 40px;">  
                    <c:forEach var="dato" items="${lista}">
                        <tr>
                            <td style="padding-left:25px;">${dato.getIdGaleria()}</td>
                            <td style="padding-left:25px;">${dato.getIdInmueble()}</td>
                            <td style="padding-left:25px;">${dato.getImagen()}</td>
                            <td style="padding-left:25px;">${dato.getUrl()}</td>
                            
                            <td style="padding-left:25px;">
                                <form action="/booktripO/controllerGaleria" method="POST">
                                    <input type="hidden" name="id" value="${dato.getIdGaleria()}">
