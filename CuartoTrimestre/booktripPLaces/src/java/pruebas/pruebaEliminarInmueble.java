...
public class pruebaEliminarInmueble {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<inmuebles> listainmueble = inmuebleDAO.ConsultarListadoInmueble(null);
        ...
        inmuebleDAO.EliminarInmueble(listainmueble.get(11));
        listainmueble = inmuebleDAO.ConsultarListadoInmueble(null);
