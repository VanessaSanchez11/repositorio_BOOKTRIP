                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                <div class="form-group row cajaCombobox">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <select name="idTipoDocumento" class="form-control select">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="fechaNacimiento" type="text" class="form-control " id="" placeholder="Fecha de nacimiento">
                                    </div>
                                    <div class="col-sm-6">
                                        <input name="password" type="password" class="form-control " id="" placeholder="Contraseña">
                                    </div>
                                </div>
                                <input type="submit" class="btn btn-primary boton" value="registroUsuario" onclick="">
