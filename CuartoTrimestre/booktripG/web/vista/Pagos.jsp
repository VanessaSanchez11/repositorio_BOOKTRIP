...
<html>
    <head>
        ...
        <link rel="stylesheet"   href="css/Pagos_estilo.css" />
    ...
    <body>
        <div class="contenedor">
            ...
            <aside>
                <form class="user" action="/booktripG/registroPagos" method="post" onsubmit="return validarInformacionPagos()">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-prepend">
                            ...
                            <input type="file" class="form-control " name ="adjunto" id="txtAdjunto" placeholder="Adjunto">
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control " name ="monto" id="txtMonto" placeholder="Monto">
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-control " name ="fechaPago" id="txtFechapago" placeholder="FechaPago">
                        </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <input type="text" class="form-control " name ="fechaPago2" id="txtFechaPago2" placeholder="FechaPago2">
                        </div>
                    </div>


                    <div class="col-12 py-3">
                        <input class="form-control d-none " id="txtBandera" type="text" name="banderaRegistro" > 
                    </div>
        ...
        <script src="js/gestionarPagos.js"></script>
