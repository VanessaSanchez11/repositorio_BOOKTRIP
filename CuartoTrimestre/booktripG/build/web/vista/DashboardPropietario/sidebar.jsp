 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index1.php">
         ...
         <div class="sidebar-brand-text mx-3">Booktrip</div>
     </a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="index1.php">Roles</a>
                 <a class="collapse-item" href="index1.php">Lista de usuarios</a>
                 <a class="collapse-item" href="index1.php">Tipo de documento</a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="indexRegistroInmueble.jsp"> registar inmuebles</a>
                   <a class="collapse-item" href="indexListaInmueble.jsp">Colsultar inmuebles</a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseLugares" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Opciones</h6>
                 <a class="collapse-item" href="index1.php">Departamentos</a>
                 <a class="collapse-item" href="index1.php">Municipios</a>
                 <a class="collapse-item" href="index1.php">Actividades</a>
             </div>
         </div>
     </li>
     <li class="nav-item">
         ...
         <div id="collapseReserva" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Opciones</h6>
                 <a class="collapse-item" href="index1.php">Lista de reservas</a>
                 <a class="collapse-item" href="index1.php">Pagos</a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseInfo" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <h6 class="collapse-header">Opciones</h6>
                 <a class="collapse-item" href="index1.php">Servicios</a>
                 <a class="collapse-item" href="index1.php">Solicitudes</a>
                 <a class="collapse-item" href="index1.php">Puntuaciones</a>
