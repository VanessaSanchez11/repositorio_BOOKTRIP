...
public class inmuebleDAO {
    ...
    public String adicionarInmueble(inmuebles inmueble) {
        ...
        try {
            ...
            System.err.println("ocurriÃ³ un problema en inmuebles\n" + ex.getMessage());
    ...
    public inmuebles consultarInmuebles(int idInmueble) {
        ...
        try {
            ...
            String Query = "select idInmueble, idTipo, idDepartamento, idUsuario, idEstado, "
                    + "nombre, direccion, capacidad, descripcion, precio, adjunto from inmuebles where idInmueble= " + idInmueble;
