...
public class actividadesDAO {
    ...
    public String adicionarActividad(actividades actividad) {
        ...
        try {
            ...
            System.err.println("ocurrio un problema en las actividades\n" + miRespuesta);
    ...
    public String actualizarActividad(actividades actividad) {
        ...
        try {
            ...
            miRespuesta = ex.getMessage();
            System.err.println("ocurriÃƒÂ³ un problema en las actividades \n" + miRespuesta);
    ...
    /*
     consultar
     */
    public actividades ConsultarActividad(String nombre) {
        ...
        try {
            ...
            String Query = "SELECT idActividad, idMunicipio, nombre, lugar, descripcion from actividades where idActividad = " + nombre;
    ...
    public ArrayList<actividades> ConsularListaActividades(String criterio) {
        ...
        try {
            ...
            String Query = "SELECT idActividad, idMunicipio, nombre, lugar, descripcion" + " FROM actividades  where nombre like '%" + criterio + "%' ORDER BY idActividad;";
            ResultSet rs = sentencia.executeQuery(Query);
            while (rs.next()) {
