...
public class municipiosDAO {
    ...
    public String adicionarMunicipios(municipios municipio) {
        ...
        try {
            ...
            System.err.println("ocurrio un problema en el municipio\n" + ex.getMessage());
    ...
    public municipios ConsultarMunicipio(String nombre) {
        ...
        try {
            ...
            String Query = "select idMunicipio, idDepartamento, nombre  from municipios  where nombre = " + nombre;
    ...
    public ArrayList<municipios> ConsularListaMunicipio(String criterio) {
        ...
        try {
            ...
            String Query = "SELECT idMunicipio, idDepartamento, nombre" + " FROM municipios  where nombre like '%" + criterio + "%' ORDER BY idMunicipio;";
            ResultSet rs = sentencia.executeQuery(Query);
            while (rs.next()) {
