...
<body>
    <header>
        <nav class="navbar navbar-light bg-primary justify-content-between">
            ...
            <form class="form-inline">
                <a href="usuariosRegister.jsp" class="btn btn-outline-light mr-sm-4">Registrarse</a>
                <a href="login.jsp" class="btn btn-outline-light mr-sm-4">Iniciar sesion</a>
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <div class="row text-center text-lg-left mb-4">
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-3">
                    ...
                    <img class="img-fluid img-thumbnail" src="img/palmera.jpg" alt="">
                    <h5 class="mt-3 font-weight-bold text-info">San Andres</h5>

                </div>
                <div class="col-lg-4 col-md-4 col-6">

                    <img class="img-fluid img-thumbnail" src="img/desierto.jpg" alt="">
                    <h5 class="mt-3 font-weight-bold text-info">Desierto de la tatacoa</h5>
                </div>
                <div class="col-lg-4 col-md-4 col-6">

                    <img class="img-fluid img-thumbnail" src="img/arbol.jpg" alt="">
                    <h5 class="mt-3 font-weight-bold text-info">Tolima</h5>
                </div>
                <div class="col-lg-4 col-md-4 col-6">

                    <img class="img-fluid img-thumbnail" src="img/agua.jpg" alt="">
                    <h5 class="mt-3 font-weight-bold text-info">Cartagena</h5>
                </div>
                <div class="col-lg-4 col-md-4 col-6">

                    <img class="img-fluid img-thumbnail" src="img/mujer.jpg" alt="">
                    <h5 class="mt-3 font-weight-bold text-info">Santa Marta</h5>
                </div>
                <div class="col-lg-4 col-md-4 col-6">

                    <img class="img-fluid img-thumbnail" src="img/patineta.jpg" alt="">
        ...
        <section class="actividades">
            ...
            <div class="card ">
                <img class="card-img-top" src="img/escalar.png" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top" src="img/treaking.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title">Treaking</h5>
                    <p class="card-text">consiste en recorrer a pie largas distancias o zonas determinadas, generalmente de alta montaña y poco frecuentadas por el turismo convencional.</p>
                    <a href="#" class="btn btn-primary">Ir a la actividad</a>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                <img class="card-img-top" src="img/evento.jpg" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="card">
                <img class="card-img-top" src="img/billar.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title">Billar</h5>
                    <p class="card-text">Es un deporte de precisión que se practica impulsando con un taco un número variable de bolas .</p>
                    <a href="#" class="btn btn-primary">Ir a la actividad</a>
                </div>
            </div>
