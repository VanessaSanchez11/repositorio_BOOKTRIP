...
public class pruebaListaUsuarios {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("<table border= \"1\"><tr><td>IdUsuario</td><td>Id tipo documento</td><td>Rol</td><td>Nombre</td><td>Apellidos</td><td>Direccion</td><td>Telefono</td><td>Fecha de nacimiento</td><td>Email</td><td>Password</td>");

        for (usuario u : user) {
            System.out.println("<tr>");
            System.out.println("<td>" + u.getIdUsuario() + "</td>");
             System.out.println("<td>" + u.getIdTipoDocumento() + "</td>");
            System.out.println("<td>" + u.getIdRol() + "</td>");
            ...
            System.out.println("<td>" + u.getPassword() + "</td>");
            System.out.println("</tr>");
        }
