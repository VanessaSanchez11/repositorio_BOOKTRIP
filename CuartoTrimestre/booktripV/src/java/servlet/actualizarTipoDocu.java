 ...
 * @author vanessa
 */
@WebServlet(name = "actualizarTipoDocu", urlPatterns = {"/actualizarTipoDocu"})
public class actualizarTipoDocu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String idDocu = request.getParameter("idTipoDocumento");
            String nombreDocu = request.getParameter("nombre");
            

            tipoDocumentosDAO tipoC = new tipoDocumentosDAO();
            tipoDocumentos tipo = new tipoDocumentos();

            int idDocumento =Integer.parseInt(idDocu);
            
            tipo.setIdTipoDocumento(idDocumento);
            tipo.setNombre(nombreDocu);
            

            String respuesta = tipoC.actualizarTipoDocumentos(tipo);
